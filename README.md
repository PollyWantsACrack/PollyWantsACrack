...
<b><u>My projects here are made for learning not commercializing so I don't generate any code with AI, and I hardly ever use it, but in other projects where time factor was important I was able to use LLM's for faster pace of work.</u></b>

Something about myself:
My name is Franek in programming my main interest are video games. I also like to work with backend and seeing how everything starts to work together. I prefer raw code over frameworks and engines. Languages that I use mostly are C++ and Java. I'm good at graphics programming in API OpenGL. I also know these technologies: HTML, CSS, SQL, JavaScript, Spring Web, Jdbc, PHP, and C#.
